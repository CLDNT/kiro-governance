 ...
 */
export declare const PROJECT_TYPES: readonly ["AppDev", "AppMod", "AIML", "default"];
export type ProjectType = typeof PROJECT_TYPES[number];
export declare const CONFIG_TYPES: readonly ["phase", "micro_artifact", "macro_checkpoint"];
export type ConfigType = typeof CONFIG_TYPES[number];
export declare const CHECKPOINT_TYPES: readonly ["human_review", "meeting", "transcript_analysis", "checklist"];
